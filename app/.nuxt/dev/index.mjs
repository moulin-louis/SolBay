...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///home/llr/SolBay/app/node_modules/h3/dist/index.mjs';
import crypto from 'crypto';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/llr/SolBay/app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify as stringify$1, uneval } from 'file:///home/llr/SolBay/app/node_modules/devalue/index.js';
import destr from 'file:///home/llr/SolBay/app/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///home/llr/SolBay/app/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/llr/SolBay/app/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///home/llr/SolBay/app/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///home/llr/SolBay/app/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/llr/SolBay/app/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/llr/SolBay/app/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/llr/SolBay/app/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///home/llr/SolBay/app/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///home/llr/SolBay/app/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/llr/SolBay/app/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///home/llr/SolBay/app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/llr/SolBay/app/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/llr/SolBay/app/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/llr/SolBay/app/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///home/llr/SolBay/app/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///home/llr/SolBay/app/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/llr/SolBay/app/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/llr/SolBay/app/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/llr/SolBay/app/server/assets"}];
...
storage.mount('db', unstorage_47drivers_47fs({"driver":"fs","base":"/home/llr/SolBay/app/data/db","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/llr/SolBay/app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/llr/SolBay/app/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/llr/SolBay/app/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/llr/SolBay/app/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/llr/SolBay/app/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _rUvRatBuvT = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/home/llr/SolBay/app";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _b6KgQXaR2f = (nitroApp) => {
  ...
  nitroApp.hooks.hook("render:html", (htmlContext) => {
    ...
    try {
      htmlContext.bodyAppend.unshift(`<script type="application/json" id="__NUXT_LOGS__">${stringify$1(ctx.logs, ctx.event.context._payloadReducers)}<\/script>`);
    } catch (e) {
...
const _gPHtyNIpqW = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_qZHJj9 = () => Promise.resolve().then(function () { return createAuction_post$1; });
const _lazy_NrfrkM = () => Promise.resolve().then(function () { return uploadFileIpfs$1; });
const _lazy_2uc7ae = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/create-auction', handler: _lazy_qZHJj9, lazy: true, middleware: false, method: "post" },
  { route: '/api/upload-file-ipfs', handler: _lazy_NrfrkM, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_2uc7ae, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2uc7ae, lazy: true, middleware: false, method: undefined }
];
...
const createAuction_post = defineEventHandler(async (event) => {
  const auction = await readBody(event);
  auction.id = v4();
  auction.created = (/* @__PURE__ */ new Date()).toISOString();
  auction.status = "open";
  auction.bids = [];
...
const createAuction_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: createAuction_post
});

const UploadToIpfs = async (data, api_jwt) => {
  useRuntimeConfig();
  try {
...
const uploadFileIpfs = defineEventHandler(async (event) => {
...
const uploadFileIpfs$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: uploadFileIpfs
});
...
const getClientManifest = () => import('file:///home/llr/SolBay/app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/llr/SolBay/app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
